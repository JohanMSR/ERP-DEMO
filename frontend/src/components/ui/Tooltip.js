      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={`absolute z-50 px-3 py-2 text-sm text-white bg-secondary-800 dark:bg-secondary-700 rounded-xl shadow-elegant whitespace-nowrap ring-1 ring-white/10 ${positionClasses[position]}`}
          >
            {content}
