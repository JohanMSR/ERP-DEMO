// Unified Theme System for Enrola - Elantar Referral Program
...
export const theme = {
  ...
  backgroundImage: {
    ...
    'orange-gradient': 'linear-gradient(135deg, rgba(249, 115, 22, 0.1), rgba(234, 88, 12, 0.05))',
    'mesh-gradient': `
...
export const cssVariables = `
  :root {
    /* Primary Colors */
    --color-orange-50: ${theme.colors.primary[50]};
    --color-orange-100: ${theme.colors.primary[100]};
    --color-orange-200: ${theme.colors.primary[200]};
    --color-orange-300: ${theme.colors.primary[300]};
    --color-orange-400: ${theme.colors.primary[400]};
    --color-orange-500: ${theme.colors.primary[500]};
    --color-orange-600: ${theme.colors.primary[600]};
    --color-orange-700: ${theme.colors.primary[700]};
    --color-orange-800: ${theme.colors.primary[800]};
    --color-orange-900: ${theme.colors.primary[900]};
    ...
    /* Accent Colors */
    --color-amber-50: ${theme.colors.accent[50]};
    --color-amber-100: ${theme.colors.accent[100]};
    --color-amber-200: ${theme.colors.accent[200]};
    --color-amber-300: ${theme.colors.accent[300]};
    --color-amber-400: ${theme.colors.accent[400]};
    --color-amber-500: ${theme.colors.accent[500]};
    --color-amber-600: ${theme.colors.accent[600]};
    --color-amber-700: ${theme.colors.accent[700]};
    --color-amber-800: ${theme.colors.accent[800]};
    --color-amber-900: ${theme.colors.accent[900]};
